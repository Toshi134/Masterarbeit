...
cat("=== NETZWERK T3 SCHÄTZEN ===\n\n")
cat("Sample size:", nrow(daten_T3_complete), "\n")
...
edge_matrix <- network_T3$graph[upper.tri(network_T3$graph)]
...
saveRDS(network_T3, "results/network_T3.rds")
cat("\n✓ Netzwerk gespeichert: results/network_T3.rds\n")
...
node_names <- colnames(daten_T3_complete)

# PDF erstellen
pdf("plots/network_T3_simple.pdf", width = 14, height = 14)
...
plot(network_T3, 
     ...
     title = "Netzwerk T3 (N = 2306)",
     mar = c(3, 3, 3, 3))

dev.off()

cat("✓ Einfache Visualisierung gespeichert: plots/network_T3_simple.pdf\n")

# Auch als PNG für schnelle Vorschau
png("plots/network_T3_simple.png", width = 2000, height = 2000, res = 150)
...
cat("✓ PNG-Version gespeichert: plots/network_T3_simple.png\n")
...
cat("\n\n=== ZUSAMMENFASSUNG ===\n")
cat("✓ Netzwerk für T3 erfolgreich geschätzt\n")
...
cat("1. Öffne plots/network_T3_simple.png um das Netzwerk anzusehen\n")
