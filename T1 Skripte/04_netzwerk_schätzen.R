...
cat("=== NETZWERK T1 SCHÄTZEN ===\n\n")
cat("Sample size:", nrow(daten_T1_complete), "\n")
...
edge_matrix <- network_T1$graph[upper.tri(network_T1$graph)]
...
saveRDS(network_T1, "results/network_T1.rds")
cat("\n✓ Netzwerk gespeichert: results/network_T1.rds\n")
...
node_names <- colnames(daten_T1_complete)

# PDF erstellen
pdf("plots/network_T1_simple.pdf", width = 14, height = 14)
...
plot(network_T1, 
     ...
     title = "Netzwerk T1 (N = 2306)",
     mar = c(3, 3, 3, 3))

dev.off()

cat("✓ Einfache Visualisierung gespeichert: plots/network_T1_simple.pdf\n")

# Auch als PNG für schnelle Vorschau
png("plots/network_T1_simple.png", width = 2000, height = 2000, res = 150)
...
cat("✓ PNG-Version gespeichert: plots/network_T1_simple.png\n")
...
cat("\n\n=== ZUSAMMENFASSUNG ===\n")
cat("✓ Netzwerk für T1 erfolgreich geschätzt\n")
...
cat("1. Öffne plots/network_T1_simple.png um das Netzwerk anzusehen\n")
