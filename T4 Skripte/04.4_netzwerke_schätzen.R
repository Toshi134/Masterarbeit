...
# Skript 04.4: Netzwerke schätzen
# ============================================
...
cat("=== NETZWERK T4 SCHÄTZEN ===\n\n")
cat("Sample size:", nrow(daten_T4_complete), "\n")
...
edge_matrix <- network_T4$graph[upper.tri(network_T4$graph)]
...
saveRDS(network_T4, "results/network_T4.rds")
cat("\n✓ Netzwerk gespeichert: results/network_T4.rds\n")
...
node_names <- colnames(daten_T4_complete)

# PDF erstellen
pdf("plots/network_T4_simple.pdf", width = 14, height = 14)
...
plot(network_T4, 
     ...
     title = "Netzwerk T4 (N = 827)",
     mar = c(3, 3, 3, 3))

dev.off()

cat("✓ Einfache Visualisierung gespeichert: plots/network_T4_simple.pdf\n")

# Auch als PNG für schnelle Vorschau
png("plots/network_T4_simple.png", width = 2000, height = 2000, res = 150)
...
cat("✓ PNG-Version gespeichert: plots/network_T4_simple.png\n")
...
cat("\n\n=== ZUSAMMENFASSUNG ===\n")
cat("✓ Netzwerk für T4 erfolgreich geschätzt\n")
...
cat("1. Öffne plots/network_T4_simple.png um das Netzwerk anzusehen\n")
